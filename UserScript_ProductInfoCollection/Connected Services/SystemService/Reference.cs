...
namespace UserScript.SystemService {
    ...
    public interface ISystemService {
        ...
        void @__SSC_AutoTouchByInputIO(string aligner, string axis, int speed, double step, double maxDistance, string io, UserScript.SystemService.SSC_IOStatusEnum activateStatus);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISystemService/__SSC_AutoTouchByInputIO", ReplyAction="http://tempuri.org/ISystemService/__SSC_AutoTouchByInputIOResponse")]
        System.Threading.Tasks.Task @__SSC_AutoTouchByInputIOAsync(string aligner, string axis, int speed, double step, double maxDistance, string io, UserScript.SystemService.SSC_IOStatusEnum activateStatus);
        ...
        UserScript.SystemService.AlignmentAreaScanResponse @__SSC_DoBlindSearchWithParam(string aligner, string horizontalAxis, string verticalAxis, double interval, double range, int speed, string analogPort);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISystemService/__SSC_DoBlindSearchWithParam", ReplyAction="http://tempuri.org/ISystemService/__SSC_DoBlindSearchWithParamResponse")]
        System.Threading.Tasks.Task<UserScript.SystemService.AlignmentAreaScanResponse> @__SSC_DoBlindSearchWithParamAsync(string aligner, string horizontalAxis, string verticalAxis, double interval, double range, int speed, string analogPort);
        ...
        UserScript.SystemService.AlignmentNDResponse @__SSC_DoFast1D(string aligner, string axis, double interval, double range, int speed, string analogPort);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISystemService/__SSC_DoFast1D", ReplyAction="http://tempuri.org/ISystemService/__SSC_DoFast1DResponse")]
        System.Threading.Tasks.Task<UserScript.SystemService.AlignmentNDResponse> @__SSC_DoFast1DAsync(string aligner, string axis, double interval, double range, int speed, string analogPort);
        ...
        UserScript.SystemService.AlignmentAngleTuningResponse @__SSC_DoFastAngleTuningWithParam(string aligner, string linearAxis, double linearInterval, double linearRange, int speed, double pitch, string analogPort, string analogPort2, string rotatingAxis, double tuningFactor, int rotatingSpeed);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISystemService/__SSC_DoFastAngleTuningWithParam", ReplyAction="http://tempuri.org/ISystemService/__SSC_DoFastAngleTuningWithParamResponse")]
        System.Threading.Tasks.Task<UserScript.SystemService.AlignmentAngleTuningResponse> @__SSC_DoFastAngleTuningWithParamAsync(string aligner, string linearAxis, double linearInterval, double linearRange, int speed, double pitch, string analogPort, string analogPort2, string rotatingAxis, double tuningFactor, int rotatingSpeed);
    ...
    public partial class SystemServiceClient : System.ServiceModel.ClientBase<UserScript.SystemService.ISystemService>, UserScript.SystemService.ISystemService {
        ...
        public void @__SSC_AutoTouchByInputIO(string aligner, string axis, int speed, double step, double maxDistance, string io, UserScript.SystemService.SSC_IOStatusEnum activateStatus) {
            base.Channel.@__SSC_AutoTouchByInputIO(aligner, axis, speed, step, maxDistance, io, activateStatus);
        }
        
        public System.Threading.Tasks.Task @__SSC_AutoTouchByInputIOAsync(string aligner, string axis, int speed, double step, double maxDistance, string io, UserScript.SystemService.SSC_IOStatusEnum activateStatus) {
        ...
        public UserScript.SystemService.AlignmentAreaScanResponse @__SSC_DoBlindSearchWithParam(string aligner, string horizontalAxis, string verticalAxis, double interval, double range, int speed, string analogPort) {
            return base.Channel.@__SSC_DoBlindSearchWithParam(aligner, horizontalAxis, verticalAxis, interval, range, speed, analogPort);
        }
        
        public System.Threading.Tasks.Task<UserScript.SystemService.AlignmentAreaScanResponse> @__SSC_DoBlindSearchWithParamAsync(string aligner, string horizontalAxis, string verticalAxis, double interval, double range, int speed, string analogPort) {
        ...
        public UserScript.SystemService.AlignmentNDResponse @__SSC_DoFast1D(string aligner, string axis, double interval, double range, int speed, string analogPort) {
            return base.Channel.@__SSC_DoFast1D(aligner, axis, interval, range, speed, analogPort);
        }
        
        public System.Threading.Tasks.Task<UserScript.SystemService.AlignmentNDResponse> @__SSC_DoFast1DAsync(string aligner, string axis, double interval, double range, int speed, string analogPort) {
        ...
        public UserScript.SystemService.AlignmentAngleTuningResponse @__SSC_DoFastAngleTuningWithParam(string aligner, string linearAxis, double linearInterval, double linearRange, int speed, double pitch, string analogPort, string analogPort2, string rotatingAxis, double tuningFactor, int rotatingSpeed) {
